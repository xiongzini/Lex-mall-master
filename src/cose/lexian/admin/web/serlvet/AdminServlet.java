...
public class AdminServlet extends BaseServlet {
     ...
     * 显示所有停用商家
     */
    public String showCloseSeller(HttpServletRequest request, HttpServletResponse response) {
        List<Seller> sellerList = adminService.findSellerByState(3);
        request.setAttribute("sellerList",sellerList);
        return  "f:/adminjsps/admin/seller/repairSellList.jsp";
    }

    /**
     * 恢复商家
     */
    public String repairSeller(HttpServletRequest request, HttpServletResponse response) {
        String s_id = request.getParameter("s_id");
        sellerService.modifySellerState(s_id, 5);
        return showCloseSeller(request, response);
    }
