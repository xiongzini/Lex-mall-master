...
$(function () {
  ...
  $(jmp[0]).click(() => {
    if (localStorage.getItem('lexian-user-u_id')) {
      window.location.href = "user/pages/like.html";
    } else {
      window.location.href = "/user/pages/person.html";
    }
  });
  $(jmp[1]).click(() => {
    if (localStorage.getItem('lexian-user-u_id')) {
      window.location.href = "/user/pages/msg.html";
    } else {
      window.location.href = "/user/pages/person.html";
    }
  });
  ...
  $(jmp[3]).click(() => {
    if (localStorage.getItem('lexian-user-u_id')) {
      window.location.href = `/ser/OrderServlet?method=findAll&u_id=${localStorage.getItem('lexian-user-u_id')}`;
    } else {
      window.location.href = "/user/pages/person.html";
    }
  });
  ...
  $(jmp[4]).click(() => {
    if (localStorage.getItem('lexian-user-u_id')) {
      window.location.href = "/user/pages/cart.html";
    } else {
      window.location.href = "/user/pages/person.html";
    }
  });
